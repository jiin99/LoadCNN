...
def main():
    ...
    criterion = nn.L1Loss()
    # test_dataset =  TimeSeries_diff_in('/daintlab/data/CER_electricity/the_end_test_onehot_del2.csv',7,'test',0)
    ...
    for tries,i in enumerate(directory):
        test_dataset = TimeSeries_diff_out('/daintlab/data/CER_electricity/the_end_test_onehot_del2.csv',7,'test',tries)
        test_loader = DataLoader(test_dataset,shuffle=False,batch_size = args.batch_size,drop_last = False)
        pre_trained_net = '/daintlab/home/jiin9/LoadCNN/cnn_diff_in_ensemble/' + i
